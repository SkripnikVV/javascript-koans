...
/* В этом разделе используется функциональное расширение, известное как Underscore.js — http://documentcloud.github.com/underscore/.
     «Underscore — это служебная библиотека для JavaScript, которая обеспечивает большую поддержку функционального программирования.
      то, что вы ожидаете от Prototype.js (или Ruby), но без расширения каких-либо встроенных объектов JavaScript.
      Это галстук, который отлично сочетается со смокингом jQuery».
 */
